...
git clone https://github.com/zarishsphere/zs-svc-allergy.git
cd zs-svc-allergy
...
See [docs.zarishsphere.com/api/zs-svc-allergy](https://docs.zarishsphere.com/api/zs-svc-allergy) for the full OpenAPI 3.1 specification.
